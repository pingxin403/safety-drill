<footer>
    <div class="pull-right">
        Copyright © ${app.scope} <a href="${app.site}" target="_blank">${app.author}</a> ·
        Powered by <a href="${app.url}" title="${app.desc}"
                      target="_blank"><strong>${app.name}</strong></a>. All Rights Reserved. Current version
        is ${app.version}.
    </div>
...
<script src="/assets/js/main.tool.js"></script>
<script src="/assets/js/main.core.js"></script>
<script src="/assets/js/main.table.js"></script>
</body>
</html>