package com.hyp.learn.cf.commons.constants;
...
public class Constant {
     ...
     * 用户权鉴缓存 key
     */
    public static final String IDENTIFY_CACHE_KEY = "shiro-cache:com.hyp.learn.cf.config.shiro.realm.JwtRealm.authorizationCache:";
}
